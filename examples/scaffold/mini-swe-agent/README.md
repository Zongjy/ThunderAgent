...
```bash
cd ThunderAgent
source examples/scaffold/mini-swe-agent/scripts/setup/setup.sh
bash examples/scaffold/mini-swe-agent/scripts/reproduce/reproduce_glm4.6.sh
# or
bash examples/scaffold/mini-swe-agent/scripts/reproduce/reproduce_qwen3_235B.sh
```
...
uv pip install -e examples/scaffold/mini-swe-agent
