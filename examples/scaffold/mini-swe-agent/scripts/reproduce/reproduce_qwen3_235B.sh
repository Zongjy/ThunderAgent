...
# Reproduce Qwen3-235B-A22B-Instruct-2507 + vLLM + ThunderAgent + mini-swe-agent SWE-bench run.
...
main() {
  ...
  [[ -d "./examples/scaffold/mini-swe-agent" ]] || die "Please run from repository root."
