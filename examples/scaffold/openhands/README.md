...
bash examples/scaffold/openhands/scripts/reproduce/reproduce_glm4.6.sh
# or
bash examples/scaffold/openhands/scripts/reproduce/reproduce_qwen3_235B.sh
```
...
3) Configure `examples/scaffold/openhands/config.toml`.
